...
function rho(::QDSimUtilities.Method"TNPI", units::QDSimUtilities.Units, sys::QDSimUtilities.System, bath::QDSimUtilities.Bath, sim::QDSimUtilities.Simulation, dat_group::HDF5.Group, sim_node; dry=false)
    if !dry
        ...
        QDSimUtilities.print_citation(ComplexTimePI.references)
    end
    ...
    if !dry
        ...
        At, _ = ComplexTimePI.A_of_t(; Hamiltonian=sys.Hamiltonian, β=bath.β, t=0.0, N=sim.ntimes, Jw=bath.Jw, svec=bath.svecs, A=idmat, extraargs)
        Z = tr(At)
